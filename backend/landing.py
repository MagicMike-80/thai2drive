...
.landing-onboard-label-lang::after{width:130px;height:12px;right:22px;bottom:-33px;transform:rotate(24deg)}
...
.landing-onboard-label-lang::before{right:-58px;bottom:-45px;border-width:17px 0 17px 32px;border-color:transparent transparent transparent #fff;transform:rotate(24deg)}
...
html.landing-onboard-active .landing-onboard-target{animation:landingOnboardPulse 3.4s ease-in-out infinite}
html.landing-onboard-active .landing-onboard-label::before,html.landing-onboard-active .landing-onboard-label::after{animation:landingArrowBlink 3.4s ease-in-out infinite}
@keyframes landingOnboardPulse{0%,100%{box-shadow:0 0 0 0 rgba(255,153,51,.20),0 0 0 0 rgba(255,255,255,.10)}18%,44%{box-shadow:0 0 0 10px rgba(255,153,51,.25),0 0 44px rgba(255,153,51,.42)}28%{box-shadow:0 0 0 3px rgba(255,255,255,.28),0 0 18px rgba(255,255,255,.24)}}
@keyframes landingLabelBlink{0%,100%{opacity:1;filter:brightness(1);box-shadow:0 16px 34px rgba(0,0,0,.34),0 0 0 5px rgba(255,153,51,.16)}12%,34%{opacity:.42;filter:brightness(.92);box-shadow:0 10px 24px rgba(0,0,0,.24),0 0 0 2px rgba(255,153,51,.08)}20%,44%{opacity:1;filter:brightness(1.18);box-shadow:0 18px 46px rgba(0,0,0,.42),0 0 0 11px rgba(255,153,51,.36),0 0 34px rgba(255,255,255,.38)}68%{opacity:1;filter:brightness(1.04);box-shadow:0 16px 38px rgba(0,0,0,.34),0 0 0 7px rgba(255,153,51,.20)}}
@keyframes landingArrowBlink{0%,100%{opacity:1;filter:brightness(1)}12%,34%{opacity:.34;filter:brightness(.85)}20%,44%{opacity:1;filter:brightness(1.28)}68%{opacity:.9}}
@media(max-width:700px){.landing-onboard-label{font-size:28px;padding:13px 22px}.landing-onboard-label-lang{top:-92px;transform:translateX(-50%) rotate(-8deg)}.landing-onboard-label-web{left:50%;top:auto;bottom:calc(100% + 78px);transform:translateX(-50%) rotate(-92deg)}.landing-onboard-label-lang::after{width:170px;height:14px;right:-68px;bottom:-58px;transform:rotate(22deg)}.landing-onboard-label-lang::before{right:-96px;bottom:-73px;transform:rotate(22deg)}.landing-onboard-label-web::after{width:210px;height:14px;bottom:-64px;transform:translateX(-50%) rotate(88deg)}.landing-onboard-label-web::before{bottom:-112px;transform:translateX(-50%) rotate(88deg)}}
@media(max-width:430px){.landing-onboard-label{font-size:23px}.landing-onboard-label-lang{top:-80px}.landing-onboard-label-web{bottom:calc(100% + 62px)}.landing-onboard-label-lang::after{width:135px}.landing-onboard-label-web::after{width:170px}}
