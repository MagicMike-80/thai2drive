...
const st = StyleSheet.create({
  safe: { flex: 1, backgroundColor: '#000508' },
  header: {
  ...
  headerSub: { fontSize: 12, marginTop: 2, color: 'rgba(0,245,255,0.5)' },
  scroll: { padding: 16, paddingBottom: 100, backgroundColor: '#000508' },
  ...
  ytPlay: {
    ...
    borderWidth: 1.5, borderColor: '#FF00E5',
  },
  platformName: {
    color: '#00F5FF', fontSize: 18, fontWeight: '900',
    textShadowColor: 'rgba(0,245,255,0.5)',
    textShadowOffset: { width: 0, height: 0 },
    textShadowRadius: 8,
  },
  platformHandle: {
    color: '#FFD700', fontSize: 13, marginTop: 1,
  ...
  descCard: {
    ...
    backgroundColor: 'rgba(0,15,24,0.5)',
  },
  descText: { fontSize: 13, lineHeight: 20, color: '#E0F7FF' },
  ...
  nativePreviewText: { fontSize: 14, opacity: 0.7, color: '#00F5FF' },

  openBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    gap: 8, paddingVertical: 13, borderRadius: 2,
    marginTop: 10,
    borderWidth: 2,
    backgroundColor: 'rgba(0,245,255,0.1)',
  },
  openBtnText: { color: '#00F5FF', fontSize: 15, fontWeight: '900', flex: 1 },
  ...
  ttIcon: {
    ...
    justifyContent: 'center', alignItems: 'center',
    borderWidth: 2, borderColor: '#FF00E5',
  },
  ttHandle: { color: '#FF00E5', fontSize: 16, fontWeight: '900' },
  ttSub: { fontSize: 12, marginTop: 1, color: '#FFD700' },
  ttStatsRow: {
    flexDirection: 'row', alignItems: 'center', gap: 0,
  },
  ttStat: { flex: 1, alignItems: 'center', gap: 2 },
  ttStatNum: { fontSize: 18, color: '#00F5FF', fontWeight: '900' },
  ttStatLbl: { color: '#FFD700', fontSize: 11 },
  ttStatDivider: { width: 1, height: 28, backgroundColor: 'rgba(0,245,255,0.2)' },
  ttOpenRow: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', gap: 8,
  },
  ttOpenLabel: { color: '#00F5FF', fontSize: 13 },

  allRow: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    borderTopWidth: 2, borderTopColor: 'rgba(0,245,255,0.3)', paddingTop: 20, marginTop: 4,
  },
  allRowLabel: { fontSize: 13, color: '#00F5FF', fontWeight: '800' },
  allBtns: { flexDirection: 'row', gap: 10 },
  allBtn: {
    width: 44, height: 44, borderRadius: 2,
    justifyContent: 'center', alignItems: 'center',
    borderWidth: 1.5, borderColor: '#00F5FF',
    backgroundColor: 'rgba(0,245,255,0.05)',
  },
});
