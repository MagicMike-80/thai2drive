...
// ── Anime Hero HTML (1M-design med Nong-karakter) ────────────────────────────
const HERO_HTML = `<!DOCTYPE html><html lang="no"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@700;900&family=Exo+2:ital,wght@0,300;0,400;1,300&display=swap" rel="stylesheet"><style>*{box-sizing:border-box;margin:0;padding:0}html,body{height:480px;overflow:hidden}body{background:#000508;font-family:'Exo 2',sans-serif;color:#F0F8FF}#r{position:relative;height:480px;overflow:hidden;display:grid;grid-template-columns:54% 46%;align-items:center;padding:36px 24px 28px}canvas{position:absolute;inset:0;z-index:0;pointer-events:none}#vig{position:absolute;inset:0;background:radial-gradient(ellipse at 50% 50%,transparent 40%,rgba(0,2,8,.92) 100%);z-index:1;pointer-events:none}.rv{opacity:0;animation:rv .7s cubic-bezier(.22,1,.36,1) var(--d,0ms) both}@keyframes rv{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:none}}#lc{position:relative;z-index:4;display:flex;flex-direction:column;padding-right:10px}.badge{display:inline-block;font-family:'Orbitron',sans-serif;font-size:8px;letter-spacing:.25em;color:rgba(0,245,255,.6);border:1px solid rgba(0,245,255,.2);padding:5px 11px;border-radius:20px;background:rgba(0,245,255,.04);text-transform:uppercase}h1{font-family:'Orbitron',sans-serif;font-size:clamp(22px,5vw,40px);font-weight:900;line-height:1.1;letter-spacing:-.01em;margin-top:13px}.g{background:linear-gradient(135deg,#00F5FF 0%,#7DF9FF 40%,#FF2D78 100%);-webkit-background-clip:text;background-clip:text;color:transparent}.sub{color:rgba(180,210,240,.36);font-size:11px;font-weight:300;line-height:1.65;margin-top:11px;font-style:italic}.cta{display:inline-block;background:linear-gradient(135deg,#00D4E8,#00F5FF);color:#000814;font-family:'Orbitron',sans-serif;font-size:9px;font-weight:700;letter-spacing:.1em;border:none;padding:11px 20px;border-radius:6px;cursor:pointer;position:relative;overflow:hidden;margin-top:17px;transition:transform .2s,box-shadow .2s}.cta:hover{transform:translateY(-2px);box-shadow:0 8px 28px rgba(0,245,255,.4)}.stats{display:flex;align-items:center;margin-top:20px}.sn{font-family:'Orbitron',sans-serif;font-size:17px;font-weight:900;color:#00F5FF;text-shadow:0 0 12px rgba(0,245,255,.5)}.sl{font-size:8px;color:rgba(150,190,220,.38);letter-spacing:.08em;text-transform:uppercase;margin-top:3px}.sdiv{width:1px;height:28px;background:rgba(255,255,255,.1);margin:0 12px}#rc{position:relative;z-index:4;display:flex;align-items:center;justify-content:center;height:100%}.cglow{position:absolute;width:200px;height:200px;border-radius:50%;background:radial-gradient(circle,rgba(0,245,255,.17) 0%,transparent 70%)}.cbeam{position:absolute;width:2px;height:400%;top:-150%;left:50%;transform:translateX(-50%);background:linear-gradient(180deg,transparent,rgba(0,245,255,.18) 40%,transparent);filter:blur(4px)}#nong{animation:fl 4s ease-in-out infinite;filter:drop-shadow(0 0 18px rgba(200,126,24,0.35));z-index:2;position:relative}@keyframes fl{0%,100%{transform:translateY(0)}50%{transform:translateY(-8px)}}.fb{position:absolute;background:rgba(2,5,16,.85);border:1px solid rgba(0,245,255,.22);border-radius:20px;padding:4px 10px;font-size:9px;font-weight:600;color:rgba(200,240,255,.8);white-space:nowrap;z-index:3;font-family:'Exo 2',sans-serif}#fa{top:8%;right:2%;animation:fba 4s ease infinite}#fb{top:36%;right:-2%;animation:fbb 5s ease infinite .5s}#fc{bottom:12%;right:4%;animation:fba 3.5s ease infinite 1s}#fd{top:14%;left:-2%;animation:fbb 4.5s ease infinite .25s}@keyframes fba{0%,100%{transform:translateY(0) rotate(-2deg)}50%{transform:translateY(-5px) rotate(1deg)}}@keyframes fbb{0%,100%{transform:translateY(0) rotate(1deg)}50%{transform:translateY(-4px) rotate(-2deg)}}</style></head><body><div id="r"><canvas id="pc"></canvas><div id="vig"></div><div id="lc"><span class="rv badge" style="--d:0ms">V5 &middot; NESTE GENERASJON</span><h1><span class="rv" style="--d:180ms">Best&aring;</span><br><span class="rv g" style="--d:360ms">teoripøven</span><br><span class="rv" style="--d:540ms">første gang.</span></h1><p class="rv sub" style="--d:720ms">Norsk trafikkteori forklart p&aring; thai<br>med AI-l&aelig;rer, quiz og video.</p><button class="rv cta" style="--d:900ms">Last ned gratis &#8599;</button><div class="rv stats" style="--d:1100ms"><div><div class="sn" id="s1">0</div><div class="sl">Studenter</div></div><div class="sdiv"></div><div><div class="sn" id="s2">0</div><div class="sl">% Best&aring;tt</div></div><div class="sdiv"></div><div><div class="sn" id="s3">0</div><div class="sl">Leksjoner</div></div></div></div><div id="rc" class="rv" style="--d:280ms"><div class="cglow"></div><div class="cbeam"></div><div class="fb" id="fa">&#9889; 8/8 Quiz</div><div class="fb" id="fb">&#128293; 7 dager</div><div class="fb" id="fc">&#127942; Rank #1</div><div class="fb" id="fd">&#127481;&#127469; &#8594; &#127475;&#127476;</div><svg id="nong" viewBox="0 0 160 292" width="160" height="285"><ellipse cx="80" cy="288" rx="30" ry="5" fill="rgba(0,0,0,0.09)"/><path d="M42,246 L42,270 Q42,278 50,280 L68,280 Q76,278 76,270 L76,246Z" fill="#5A3412"/><path d="M40,264 Q40,280 50,283 L70,283 Q80,280 80,267 L80,262 L40,262Z" fill="#3E2408"/><line x1="46" y1="252" x2="72" y2="252" stroke="#8A5830" stroke-width="1.1"/><line x1="46" y1="258" x2="72" y2="258" stroke="#8A5830" stroke-width="1.1"/><line x1="46" y1="264" x2="72" y2="264" stroke="#8A5830" stroke-width="1.1"/><path d="M84,246 L84,270 Q84,278 92,280 L110,280 Q118,278 118,270 L118,246Z" fill="#5A3412"/><path d="M80,264 Q80,280 90,283 L110,283 Q120,280 120,267 L120,262 L80,262Z" fill="#3E2408"/><line x1="88" y1="252" x2="114" y2="252" stroke="#8A5830" stroke-width="1.1"/><line x1="88" y1="258" x2="114" y2="258" stroke="#8A5830" stroke-width="1.1"/><line x1="88" y1="264" x2="114" y2="264" stroke="#8A5830" stroke-width="1.1"/><rect x="44" y="196" width="28" height="56" rx="3" fill="#1E2540"/><line x1="58" y1="196" x2="58" y2="250" stroke="#161C30" stroke-width="0.7"/><rect x="88" y="196" width="28" height="56" rx="3" fill="#1E2540"/><line x1="102" y1="196" x2="102" y2="250" stroke="#161C30" stroke-width="0.7"/><path d="M20,116 Q16,104 20,90 Q28,74 46,68 L46,206 Q60,214 80,214 Q100,214 114,206 L114,68 Q132,74 140,90 Q144,104 140,116 L140,200 Q140,212 126,218 Q104,224 80,224 Q56,224 34,218 Q20,212 20,200Z" fill="#C87E18"/><line x1="80" y1="70" x2="80" y2="212" stroke="#9A6010" stroke-width="1.2" stroke-dasharray="3,2.5"/><path d="M22,158 Q80,168 138,158" stroke="#9A6010" stroke-width="2.2" fill="none"/><rect x="26" y="170" width="30" height="24" rx="5" fill="#9A6010" opacity="0.45"/><rect x="104" y="170" width="30" height="24" rx="5" fill="#9A6010" opacity="0.45"/><rect x="37" y="178" width="8" height="4" rx="2" fill="#C87E18"/><rect x="115" y="178" width="8" height="4" rx="2" fill="#C87E18"/><path d="M20,90 Q8,118 10,158 L28,158 L34,90Z" fill="#C87E18"/><path d="M140,90 Q152,118 150,158 L132,158 L126,90Z" fill="#C87E18"/><ellipse cx="15" cy="160" rx="12" ry="9" fill="#1A1A1A"/><ellipse cx="145" cy="160" rx="12" ry="9" fill="#1A1A1A"/><path d="M38,80 Q52,68 80,66 Q108,68 122,80 Q126,92 120,102 Q102,114 80,116 Q58,114 40,102 Q34,92 38,80Z" fill="#EED8A4"/><path d="M42,82 Q60,74 80,72 Q100,74 118,82" stroke="#D8C488" stroke-width="4" fill="none" stroke-linecap="round"/><path d="M48,86 Q64,80 80,82 Q96,80 112,86 Q108,100 80,104 Q52,100 48,86Z" fill="#F4E8C0"/><path d="M90,22 Q96,0 118,0 Q142,2 152,20 Q158,40 152,64 Q144,82 128,88 Q116,92 108,84 Q120,76 122,62 Q130,44 124,24 Q114,8 102,12 Q94,16 92,22Z" fill="#120C06"/><path d="M104,8 Q122,6 136,22 Q146,38 140,58" stroke="#2A1A0E" stroke-width="2" fill="none" stroke-linecap="round"/><ellipse cx="78" cy="44" rx="36" ry="38" fill="#120C06"/><path d="M44,36 Q50,12 78,10 Q106,12 112,36" fill="#120C06"/><ellipse cx="78" cy="50" rx="30" ry="34" fill="#F0B480"/><ellipse cx="48.5" cy="54" rx="5" ry="7" fill="#DFA070"/><ellipse cx="107.5" cy="54" rx="5" ry="7" fill="#DFA070"/><ellipse cx="62" cy="46" rx="13.5" ry="15" fill="#160A04"/><ellipse cx="62" cy="47.5" rx="11.5" ry="12.5" fill="#7A4018"/><ellipse cx="62" cy="49.5" rx="7.5" ry="9" fill="#2A1006"/><ellipse cx="58.5" cy="43" rx="4.5" ry="5" fill="white"/><circle cx="68" cy="55" r="2" fill="white" opacity="0.6"/><path d="M48,56 Q62,62 76,56" stroke="#160A04" stroke-width="1.2" fill="none" stroke-linecap="round"/><ellipse cx="94" cy="46" rx="13.5" ry="15" fill="#160A04"/><ellipse cx="94" cy="47.5" rx="11.5" ry="12.5" fill="#7A4018"/><ellipse cx="94" cy="49.5" rx="7.5" ry="9" fill="#2A1006"/><ellipse cx="90.5" cy="43" rx="4.5" ry="5" fill="white"/><circle cx="100" cy="55" r="2" fill="white" opacity="0.6"/><path d="M80,56 Q94,62 108,56" stroke="#160A04" stroke-width="1.2" fill="none" stroke-linecap="round"/><path d="M48,31 Q62,25 76,31" stroke="#120C06" stroke-width="3.2" fill="none" stroke-linecap="round"/><path d="M80,31 Q94,25 108,31" stroke="#120C06" stroke-width="3.2" fill="none" stroke-linecap="round"/><path d="M51,26 Q62,20 73,26" stroke="#120C06" stroke-width="2.8" fill="none" stroke-linecap="round"/><path d="M83,26 Q94,20 105,26" stroke="#120C06" stroke-width="2.8" fill="none" stroke-linecap="round"/><circle cx="78" cy="62" r="2.5" fill="#CC8860" opacity="0.45"/><path d="M64,75 Q78,86 92,75" stroke="#C06848" stroke-width="2.5" fill="none" stroke-linecap="round"/><path d="M66,75 Q78,82 90,75 Q78,78 66,75Z" fill="white" opacity="0.65"/><ellipse cx="44" cy="62" rx="11" ry="6.5" fill="#FF8888" opacity="0.2"/><ellipse cx="112" cy="62" rx="11" ry="6.5" fill="#FF8888" opacity="0.2"/></svg></div></div><script>setTimeout(function(){var targets=[[document.getElementById('s1'),12450,''],[document.getElementById('s2'),94,'%'],[document.getElementById('s3'),48,'']];targets.forEach(function(item){var el=item[0],t=item[1],sfx=item[2],n=0;var iv=setInterval(function(){n+=Math.ceil((t-n)/8);el.textContent=(n>=t?t:n).toLocaleString('no')+sfx;if(n>=t)clearInterval(iv);},50);});},1200);var cv=document.getElementById('pc'),cx=cv.getContext('2d'),W,H,ps=[];function rsz(){W=cv.width=window.innerWidth;H=cv.height=480;}rsz();window.addEventListener('resize',rsz);function P(){this.reset(true);}P.prototype.reset=function(i){this.x=Math.random()*W;this.y=Math.random()*H;this.vx=(Math.random()-.5)*.18;this.vy=(Math.random()-.5)*.18;this.r=Math.random()*1.8+.5;this.c=Math.random()>.6?'rgba(0,245,255,':'rgba(100,80,255,';this.a=Math.random()*.13+.03;this.life=i?Math.random()*400:0;this.mx=Math.random()*350+180;};P.prototype.step=function(){this.x+=this.vx;this.y+=this.vy;this.life++;if(this.life>this.mx||this.x<0||this.x>W||this.y<0||this.y>H)this.reset(false);};P.prototype.draw=function(){var p=Math.sin(Math.PI*this.life/this.mx);cx.beginPath();cx.arc(this.x,this.y,this.r,0,Math.PI*2);cx.fillStyle=this.c+(this.a*p)+')';cx.fill();};for(var i=0;i<22;i++)ps.push(new P());(function loop(){cx.clearRect(0,0,W,H);ps.forEach(function(p){p.step();p.draw();});requestAnimationFrame(loop);})();</script></body></html>`;
